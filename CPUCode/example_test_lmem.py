...
import numpy as np
from DFEBDT import DFEBDT, DFEBDT_readLMem, DFEBDT_writeLMem
...
nFeatures = 2
startWrite = 0
startRead = nFeatures * n * n
DFEBDT_writeLMem(n * n, startWrite, dfedata)
DFEBDT(n * n)
Z_DFE = DFEBDT_readLMem(n * n, startRead)
